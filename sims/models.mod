...
.MODEL LED23 D(Is=4.5e-20 Rs=.85 N=2.33 Cjo=1.18n Iave=400mA Vpk=5 mfg=Lumileds type=LED)
...
+ Vj=.75 Fc=.5 Isr=2.035n Nr=2 Bv=3.2 Ibv=45.862m Nbv=3.0477
+ Ibvl=29.831m Nbvl=11.606 Tbv1=-636.4u)



.MODEL D1N4756 D(IS=2.67E-9 RS=50.3 TT=5.01E-8 CJO=3.52E-11 M=0.33 
+ BV=46.74 IBV=0.0055 )
