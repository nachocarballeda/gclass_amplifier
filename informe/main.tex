...
La relación de resistencias queda definida por las especificaciones de sensibilidad y potencia RMS para una carga de $8\Omega$. La ganancia del amplificador debe ser de $29dB$.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{img/bloques}
...
\paragraph{Cuestiones generales}
Se intentó conservar la simertía del circuito en su diseño. Esto motivó, entre otras cosas, al uso de un doble par diferencial a la entrada, o el de un multiplicador de $V_{be}$ simétrico.
